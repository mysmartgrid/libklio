    ...
    )
{
  ...
  return createSensor(u, name, klio::DEFAULT_SENSOR_DESCRIPTION, unit, timezone, klio::DEFAULT_SENSOR_TOKEN);
}
...
{
  return createSensor(uuid_string, name, description, unit, timezone, klio::DEFAULT_SENSOR_TOKEN);
}
    ...
    )
{
  ...
  return createSensor(u, name, description, unit, timezone, token);
}
    ...
    )
{
  ...
  return Sensor::Ptr(new Sensor(uuid, name, description, unit, timezone, token));
}
